...
<body id="home-mobile">
    ...
    <div class="navbar-fixed-top">
        ...
        <div id="menu-list">
            <div class="clearfix">
                <h5 class="pull-left">Welcome</h5>
                <div id="logo">
                    <div id="logo-angle"></div>
                    <div id="logo-img"><a href="javascript:void(0);"><img src="images/logo-neue.png" class="img-responsive" alt="NEUE Hair Salon"></a></div>
                </div>
            </div>
        </div>
    </div>
    
    <div id="menu-wrapper" class="opened">
        ...
        <div class="text-center">            
            <ul class="nav-list list-unstyled">
            	<li><p class="mbn">A new you awaits at Singapore's newest hair salon. Flaunt it with the help of a team of top hair artists, for an iconic style that's all you, all NEUE.</p></li>
